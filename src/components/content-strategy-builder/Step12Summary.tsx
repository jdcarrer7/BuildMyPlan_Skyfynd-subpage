              ...
              <div className="space-y-4 mt-6">
                ...
                <div className="p-4 bg-[var(--bg-card)] rounded-lg border border-[var(--border-subtle)]">
                  ...
                  <div className="space-y-3">
                    {/* Content Goal */}
                    <SummarySection title="Content Strategy Goal" icon={<Target className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={1}>
                    ...
                    {/* Content Audit */}
                    <SummarySection title="Content Audit & Assessment" icon={<Search className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={3}>
                      <div className="flex justify-between">
                    ...
                    {/* Audience & Personas */}
                    <SummarySection title="Audience & Persona Strategy" icon={<Users className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={4}>
                      <div className="flex justify-between">
                    ...
                    {/* Channel Strategy */}
                    <SummarySection title="Channel Strategy" icon={<Share2 className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={5}>
                      <div className="flex justify-between">
                    ...
                    {/* SEO Strategy */}
                    <SummarySection title="SEO & Search Strategy" icon={<Search className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={7}>
                      <div className="flex justify-between">
                ...
                <div className="p-4 bg-[var(--bg-card)] rounded-lg border border-[var(--border-subtle)]">
                  ...
                  <div className="space-y-3">
                    {/* Editorial Planning */}
                    <SummarySection title="Editorial Planning" icon={<Calendar className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={6}>
                      <div className="flex justify-between">
                    ...
                    {/* Content Governance */}
                    <SummarySection title="Content Governance" icon={<Shield className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={8}>
                      <div className="flex justify-between">
                    ...
                    <SummarySection title="Measurement & Analytics" icon={<BarChart3 className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={9}>
                      <div className="flex justify-between">
