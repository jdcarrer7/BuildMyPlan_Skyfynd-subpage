...
import { timelineOptions } from '@/data/contentStrategyBuilder';
...
export default function Step11Timeline() {
  const { timeline, setTimeline, projectSubtotal } = useContentStrategyBuilderStore();
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="text-lg font-semibold">
                    {option.multiplier === 1 ? (
                      <span className="text-[var(--accent-blue-light)]">Flexible ({getMultiplierLabel(option.multiplier)})</span>
                    ) : (
