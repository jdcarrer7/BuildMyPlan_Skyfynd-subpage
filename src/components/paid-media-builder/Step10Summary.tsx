        ...
        <div className={`grid transition-all duration-300 ease-in-out ${expandedCard === 'paid-media' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
          <div className="overflow-hidden">
            <div className="space-y-4 mt-6">
                <SummarySection title="Campaign Type" icon={<Target className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={1}>
                ...
                <SummarySection title="Ad Spend Budget" icon={<DollarSign className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={3}>
                  <div className="flex justify-between">
                ...
                <SummarySection title="Duration" icon={<Calendar className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={4}>
                  <div className="flex justify-between">
                ...
                <SummarySection title="Management" icon={<Settings className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={5}>
                  <div className="flex justify-between">
                ...
                <SummarySection title="Creatives" icon={<Palette className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={6}>
                ...
                <SummarySection title="Tracking" icon={<BarChart3 className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={7}>
                  <div className="flex justify-between">
                ...
                <SummarySection title="Reporting" icon={<FileText className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={8}>
                  <div className="flex justify-between">
