...
interface SoundPriceSidebarProps {
  currentStep?: number;
  onGoToSummary?: () => void;
}
...
export default function SoundPriceSidebar({ currentStep, onGoToSummary }: SoundPriceSidebarProps) {
  const {
    subtotal,
    rushFee,
    total,
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-white">Sound Estimate</h3>
      </div>
