...
import { formatOptions, projectFileOptions, licenseOptions } from '@/data/soundBuilder';
import { Check, HelpCircle, FileAudio, FolderOpen, Shield } from 'lucide-react';
...
export default function Step7Deliverables() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-semibold text-white mb-2">Choose your deliverables</h2>
        <p className="text-[var(--text-secondary)]">
          Select the file formats, source files, and licensing for your audio.
        </p>
      </div>
