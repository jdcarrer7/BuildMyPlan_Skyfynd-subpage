...
import { addOnServices } from '@/data/visualIdentityBuilder';
import { Check, HelpCircle, Plus, Sparkles } from 'lucide-react';
import { useState } from 'react';

export default function Step11AddOns() {
  const { selectedAddOns, toggleAddOn } = useVisualIdentityBuilderStore();
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[var(--text-secondary)]">
          Enhance your visual identity with specialized add-on services. Select as many as you need.
        </p>
      </div>
