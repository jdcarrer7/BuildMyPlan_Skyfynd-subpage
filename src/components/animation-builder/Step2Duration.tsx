...
import { durationOptions } from '@/data/animationBuilder';
import { HelpCircle, Check, Clock } from 'lucide-react';
import { useState } from 'react';

export default function Step2Duration() {
  const { duration, setDuration } = useAnimationBuilderStore();
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h2 className="text-2xl font-semibold text-white font-serif">
            How long does your animation need to be?
          </h2>
        </div>
        <p className="text-[var(--text-secondary)]">
          Duration affects complexity and pricing. We&apos;ve pre-selected based on your animation type.
        </p>
      </div>
