...
import { addOnServices } from '@/data/brandApplicationsBuilder';
import { Check, HelpCircle, Plus, Sparkles } from 'lucide-react';
import { useState } from 'react';

export default function Step10AddOns() {
  const { selectedAddOns, toggleAddOn } = useBrandApplicationsBuilderStore();
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[var(--text-secondary)]">
          Enhance your brand applications with specialized add-on services. Select as many as you need.
        </p>
      </div>
