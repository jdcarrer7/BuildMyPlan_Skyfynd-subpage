...
import { timelineOptions } from '@/data/brandApplicationsBuilder';
...
export default function Step11Timeline() {
  const { timeline, setTimeline, projectSubtotal } = useBrandApplicationsBuilderStore();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm text-[var(--text-muted)]">
        ...
        <span>Choose your delivery timeline</span>
      </div>
