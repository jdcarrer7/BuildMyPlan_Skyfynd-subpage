...
import { aiFeatures } from '@/data/appBuilder';
import { Check, Plus, ChevronDown, ChevronUp, Sparkles, Zap } from 'lucide-react';

export default function Step8AIFeatures() {
  const {
    selectedAIFeatures,
    toggleAIFeature,
    isAIFeatureSelected,
    ...
    <div className="card p-6">
      <div className="mb-6">
        ...
        <p className="text-[var(--text-secondary)]">
          Add intelligent features to your app. AI features have a one-time setup cost and optional monthly usage fees.
        </p>
