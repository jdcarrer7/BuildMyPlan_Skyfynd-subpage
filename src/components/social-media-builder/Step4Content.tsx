...
import { contentOptions } from '@/data/socialMediaBuilder';
import { Check, HelpCircle, X } from 'lucide-react';
import { useState } from 'react';

export default function Step4Content() {
  const { content, setContent } = useSocialMediaBuilderStore();
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-semibold text-white mb-2">What level of content creation do you need?</h2>
        <p className="text-[var(--text-secondary)]">
          Choose how much creative support you need for your social media content.
        </p>
      </div>
