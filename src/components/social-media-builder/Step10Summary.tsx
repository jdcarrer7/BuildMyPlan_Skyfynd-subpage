        ...
        <div className={`grid transition-all duration-300 ease-in-out ${expandedCard === 'social-media' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
          <div className="overflow-hidden">
            <div className="space-y-4 mt-6">
                <SummarySection title="Management Goal" icon={<Target className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={1}>
                  <p className="text-[var(--text-secondary)]">{goalLabel}</p>
                </SummarySection>

                <SummarySection title="Platforms" icon={<Globe className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={2}>
                ...
                <SummarySection title="Posting Frequency" icon={<FileText className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={3}>
                  <div className="flex justify-between">
                ...
                <SummarySection title="Content Creation" icon={<Lightbulb className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={4}>
                  <div className="flex justify-between">
                ...
                <SummarySection title="Engagement" icon={<MessageCircle className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={5}>
                  <div className="flex justify-between">
                ...
                <SummarySection title="Strategy" icon={<Users className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={6}>
                  <div className="flex justify-between">
                ...
                <SummarySection title="Reporting" icon={<BarChart3 className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={7}>
                  <div className="flex justify-between">
                ...
                <SummarySection title="Add-ons" icon={<Zap className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={8}>
                ...
                <SummarySection title="Duration" icon={<Calendar className="w-5 h-5 text-[var(--accent-blue)]" />} stepNumber={9}>
                  <div className="flex justify-between">
              ...
              <div className="overflow-hidden">
                <div className="space-y-4 mt-6">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    ...
                    <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                      <div className="flex items-center gap-2 mb-3">
                        <Lightbulb className="w-5 h-5 text-[var(--accent-blue)]" />
