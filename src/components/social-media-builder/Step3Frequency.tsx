...
import { frequencyOptions } from '@/data/socialMediaBuilder';
import { Check, HelpCircle, X } from 'lucide-react';
import { useState } from 'react';

export default function Step3Frequency() {
  const { frequency, setFrequency } = useSocialMediaBuilderStore();
  const [tooltipOpen, setTooltipOpen] = useState<string | null>(null);

  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-semibold text-white mb-2">How often do you want to post?</h2>
        <p className="text-[var(--text-secondary)]">
          Choose a posting frequency that matches your engagement goals and content capacity.
        </p>
      </div>
            ...
            <div key={option.id} className="relative">
              ...
              >
                <div className="flex flex-col gap-2">
                  ...
                  {/* Posts per month and price display */}
                  <div className="mt-1 flex flex-col gap-1">
                    {option.postsPerMonth && (
