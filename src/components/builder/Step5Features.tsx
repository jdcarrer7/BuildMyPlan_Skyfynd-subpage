...
import { features } from '@/data/websiteBuilder';
import { Check, Plus, ChevronDown, ChevronUp } from 'lucide-react';

export default function Step5Features() {
  const { selectedFeatures, toggleFeature, isFeatureSelected, getFeatureOption, setFeatureOption } = useBuilderStore();
    ...
    <div className="card p-6">
      <div className="mb-6">
        ...
        <p className="text-[var(--text-secondary)]">
          Select the features you need. Click to expand and choose options.
        </p>
