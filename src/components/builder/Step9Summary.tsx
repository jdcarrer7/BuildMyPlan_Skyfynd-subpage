        ...
        <div className={`grid transition-all duration-300 ease-in-out ${expandedCard === 'website' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
          <div className="overflow-hidden">
            <div className="space-y-4 mt-6">
              {/* Project Type */}
              <SummarySection title="Project Type" icon={<FileText className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={1}>
                <p className="text-[var(--text-secondary)]">{projectTypeLabel}</p>
              </SummarySection>

              {/* Site Size */}
              <SummarySection title="Site Size" icon={<Layers className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={2}>
              ...
              {/* Design */}
              <SummarySection title="Design Style" icon={<Palette className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={3}>
                <div className="flex justify-between">
              ...
              {/* CMS */}
              <SummarySection title="Content Management" icon={<Database className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={4}>
                <div className="flex justify-between">
              ...
              {/* Features */}
              <SummarySection title="Features" icon={<Wrench className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={5}>
              ...
              {/* AI Features */}
              <SummarySection title="AI Features" icon={<Sparkles className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={6}>
              ...
              {/* Additional Services */}
              <SummarySection title="Additional Services" icon={<Check className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={7}>
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-app?step=1" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-app?step=2" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-app?step=3" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-app?step=4" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-app?step=5" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <Server className="w-5 h-5 text-[var(--accent-purple)]" />
                        <h3 className="font-medium text-white">Backend</h3>
                      </div>
                      <Link href="/build-my-app?step=6" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-app?step=7" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-app?step=8" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-app?step=9" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-app?step=10" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-ai-receptionist?step=1" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-ai-receptionist?step=2" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-ai-receptionist?step=3" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-ai-receptionist?step=4" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-ai-receptionist?step=5" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-ai-receptionist?step=6" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Link href="/build-my-ai-receptionist?step=7" className="text-[var(--text-muted)] hover:text-[var(--accent-purple)] transition-colors">
                        <Edit2 className="w-4 h-4" />
                      </Link>
                    </div>
                    <div className="space-y-2">
