...
import { messagingOptions } from '@/data/brandStrategyBuilder';
import { Check, HelpCircle, X } from 'lucide-react';
import { useState } from 'react';

export default function Step5Messaging() {
  const { messaging, setMessaging } = useBrandStrategyBuilderStore();
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-semibold text-white mb-2">What messaging deliverables do you need?</h2>
        <p className="text-[var(--text-secondary)]">
          Messaging frameworks help ensure consistent communication across all touchpoints.
        </p>
      </div>
