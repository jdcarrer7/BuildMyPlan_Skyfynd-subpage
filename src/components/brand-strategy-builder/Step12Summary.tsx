...
import { useUnifiedQuoteStore, serviceMetadata, WebsiteConfig, AppConfig, AnimationConfig, ImageConfig, SoundConfig, PaidMediaConfig, SocialMediaConfig, EmailMarketingConfig, VisualIdentityConfig, BrandApplicationsConfig } from '@/hooks/useUnifiedQuoteStore';
import {
  strategyGoalOptions,
  depthOptions,
  researchOptions,
...
type ExpandedCard = 'brand-strategy' | 'website' | 'app' | 'animation' | 'image' | 'sound' | 'paid-media' | 'social-media' | 'email-marketing' | 'visual-identity' | 'brand-applications' | null;
              ...
              <div className="space-y-4 mt-6">
                ...
                <div className="p-4 bg-[var(--bg-card)] rounded-lg border border-[var(--border-subtle)]">
                  ...
                  <div className="space-y-3">
                    {/* Strategy Goal */}
                    <SummarySection title="Strategy Goal" icon={<Target className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={1}>
                    ...
                    {/* Research */}
                    <SummarySection title="Research & Discovery" icon={<Compass className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={3}>
                      <div className="flex justify-between">
                    ...
                    {/* Positioning */}
                    <SummarySection title="Positioning & Differentiation" icon={<Target className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={4}>
                      <div className="flex justify-between">
                    ...
                    {/* Messaging */}
                    <SummarySection title="Brand Messaging" icon={<MessageSquare className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={5}>
                      <div className="flex justify-between">
                    ...
                    {/* Architecture */}
                    <SummarySection title="Brand Architecture" icon={<Layers className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={6}>
                      <div className="flex justify-between">
                    ...
                    {/* Purpose */}
                    <SummarySection title="Purpose, Vision & Values" icon={<Heart className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={7}>
                      <div className="flex justify-between">
                    ...
                    {/* Audience */}
                    <SummarySection title="Target Audience & Personas" icon={<Users className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={8}>
                      <div className="flex justify-between">
                    ...
                    {/* Workshop */}
                    <SummarySection title="Strategy Workshops" icon={<Users className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={9}>
                      <div className="flex justify-between">
                ...
                {/* Timeline Section */}
                <SummarySection title="Timeline" icon={<Calendar className="w-5 h-5 text-[var(--accent-purple)]" />} stepNumber={11}>
                  <div className="flex justify-between">
